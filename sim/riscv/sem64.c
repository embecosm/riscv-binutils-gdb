...
if (EQDI (GET_H_XLEN (), 32)) {
  {
    DI opval = SRLDI (MULDI (EXTSIDI (TRUNCDISI (GET_H_GPR (FLD (f_rs1)))), ZEXTSIDI (TRUNCDISI (GET_H_GPR (FLD (f_rs2))))), 32);
    SET_H_GPR (FLD (f_rd), opval);
    written |= (1 << 3);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_fmadd_s.f
  ...
  {
    DI opval = EXTSIDI (MULSI (GET_H_GPR (FLD (f_rs1)), GET_H_GPR (FLD (f_rs2))));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_fmadd_s.f
  ...
  {
    DI opval = EXTSIDI (DIVSI (GET_H_GPR (FLD (f_rs1)), GET_H_GPR (FLD (f_rs2))));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_fmadd_s.f
  ...
  {
    DI opval = EXTSIDI (UDIVSI (GET_H_GPR (FLD (f_rs1)), GET_H_GPR (FLD (f_rs2))));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_fmadd_s.f
  ...
  {
    DI opval = EXTSIDI (MODSI (GET_H_GPR (FLD (f_rs1)), GET_H_GPR (FLD (f_rs2))));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_fmadd_s.f
  ...
  {
    DI opval = EXTSIDI (UMODSI (GET_H_GPR (FLD (f_rs1)), GET_H_GPR (FLD (f_rs2))));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_csrrw.f
  ...
  {
    DI opval = GETMEMSI (current_cpu, pc, GET_H_GPR (FLD (f_rs1)));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
#define FLD(f) abuf->fields.sfmt_csrrw.f
  ...
  {
    DI opval = GETMEMDI (current_cpu, pc, GET_H_GPR (FLD (f_rs1)));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
/* sbsetiw-shift5: sbsetiw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,sbsetiw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsri.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* sbclriw-shift5: sbclriw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,sbclriw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsri.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* sbinviw-shift5: sbinviw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,sbinviw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsri.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* sloiw-shift5: sloiw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,sloiw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsriw.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* sroiw-shift5: sroiw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,sroiw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsriw.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
#define FLD(f) abuf->fields.sfmt_fsri.f
  ...
  {
    DI opval = RORDI (GET_H_GPR (FLD (f_rs1)), ANDDI (FLD (f_uimm6_256), 63));
    SET_H_GPR (FLD (f_rd), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "gpr", 'D', opval);
  }
...
/* roriw-shift5: roriw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,roriw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsriw.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* greviw-shift5: greviw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,greviw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsriw.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* gorciw-shift5: gorciw ${rd},${rs1},${uimm5-245} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,gorciw_shift5) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_fsriw.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...
/* slliu.w-shift7: slliu.w ${rd},${rs1},${uimm7-267} */

static SEM_PC
SEM_FN_NAME (riscv64bf_rv64,slliu_w_shift7) (SIM_CPU *current_cpu, SEM_ARG sem_arg)
{
#define FLD(f) abuf->fields.sfmt_empty.f
  ARGBUF *abuf = SEM_ARGBUF (sem_arg);
  int UNUSED written = 0;
...

{
  ...
  tmp_saved_rm = GET_H_CSR (((UINT) 2));
  {
    UDI opval = FLD (f_funct3);
    SET_H_CSR (((UINT) 2), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "csr", 'D', opval);
  }
  tmp_res = CGEN_CPU_FPU (current_cpu)->ops->muladdsf (CGEN_CPU_FPU (current_cpu), tmp_lhs, tmp_rhs, tmp_addend);
  {
    UDI opval = tmp_saved_rm;
    SET_H_CSR (((UINT) 2), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "csr", 'D', opval);
  }
  {
...

{
  ...
  tmp_res = CGEN_CPU_FPU (current_cpu)->ops->muladdsf (CGEN_CPU_FPU (current_cpu), tmp_lhs, tmp_rhs, CGEN_CPU_FPU (current_cpu)->ops->negsf (CGEN_CPU_FPU (current_cpu), tmp_addend));
  {
    UDI opval = tmp_saved_rm;
    SET_H_CSR (((UINT) 2), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "csr", 'D', opval);
...

{
  ...
  tmp_res = CGEN_CPU_FPU (current_cpu)->ops->muladdsf (CGEN_CPU_FPU (current_cpu), CGEN_CPU_FPU (current_cpu)->ops->negsf (CGEN_CPU_FPU (current_cpu), tmp_lhs), tmp_rhs, tmp_addend);
  {
    UDI opval = tmp_saved_rm;
    SET_H_CSR (((UINT) 2), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "csr", 'D', opval);
...

{
  ...
  tmp_res = CGEN_CPU_FPU (current_cpu)->ops->muladdsf (CGEN_CPU_FPU (current_cpu), CGEN_CPU_FPU (current_cpu)->ops->negsf (CGEN_CPU_FPU (current_cpu), tmp_lhs), tmp_rhs, CGEN_CPU_FPU (current_cpu)->ops->negsf (CGEN_CPU_FPU (current_cpu), tmp_addend));
  {
    UDI opval = tmp_saved_rm;
    SET_H_CSR (((UINT) 2), opval);
    CGEN_TRACE_RESULT (current_cpu, abuf, "csr", 'D', opval);
...

{
  ...
  {
    DF opval = SUBWORDDIDF (ORDI (ZEXTSIDI (SUBWORDSFSI (CGEN_CPU_FPU (current_cpu)->ops->ftruncdfsf (CGEN_CPU_FPU (current_cpu), 0, CGEN_CPU_FPU (current_cpu)->ops->floatdidf (CGEN_CPU_FPU (current_cpu), 0, GET_H_GPR (FLD (f_rs1)))))), MAKEDI (0xffffffff, 0)));
    CPU (h_fpr[FLD (f_rd)]) = opval;
    CGEN_TRACE_RESULT (current_cpu, abuf, "fpr", 'f', opval);
  }
  {
...

{
  ...
  {
    DF opval = SUBWORDDIDF (ORDI (ZEXTSIDI (SUBWORDSFSI (CGEN_CPU_FPU (current_cpu)->ops->ftruncdfsf (CGEN_CPU_FPU (current_cpu), 0, CGEN_CPU_FPU (current_cpu)->ops->ufloatdidf (CGEN_CPU_FPU (current_cpu), 0, GET_H_GPR (FLD (f_rs1)))))), MAKEDI (0xffffffff, 0)));
    CPU (h_fpr[FLD (f_rd)]) = opval;
    CGEN_TRACE_RESULT (current_cpu, abuf, "fpr", 'f', opval);
  }
  {
...
static const struct sem_fn_desc sem_fns[] = {
  ...
  { RISCV64BF_RV64_INSN_SBSETIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,sbsetiw_shift5) },
  { RISCV64BF_RV64_INSN_SBCLRIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,sbclriw_shift5) },
  { RISCV64BF_RV64_INSN_SBINVIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,sbinviw_shift5) },
  ...
  { RISCV64BF_RV64_INSN_SLOIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,sloiw_shift5) },
  { RISCV64BF_RV64_INSN_SROIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,sroiw_shift5) },
  ...
  { RISCV64BF_RV64_INSN_RORIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,roriw_shift5) },
  ...
  { RISCV64BF_RV64_INSN_GREVIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,greviw_shift5) },
  ...
  { RISCV64BF_RV64_INSN_GORCIW_SHIFT5, SEM_FN_NAME (riscv64bf_rv64,gorciw_shift5) },
  ...
  { RISCV64BF_RV64_INSN_SLLIU_W_SHIFT7, SEM_FN_NAME (riscv64bf_rv64,slliu_w_shift7) },
