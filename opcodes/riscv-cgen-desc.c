...
const CGEN_IFLD riscv_cgen_ifld_table[] =
{
  ...
  { RISCV_F_FUNCT1, "f-funct1", 0, 32, 26, 1, { 0, { { { (1<<MACH_BASE), 0 } }, { { 1, "\xc0" } } } }  },
  ...
  { RISCV_F_UIMM7_267, "f-uimm7-267", 0, 32, 26, 7, { 0, { { { (1<<MACH_BASE), 0 } }, { { 1, "\xc0" } } } }  },
...
/* c.flwsp ${fl-rd},${uimm8-32-121-63-00-abs}(${sp-reg}) */
  {
    ...
    { 0, { { { (1<<MACH_RV32GC)|(1<<MACH_RV32GQC), 0 } }, { { 1, "\x80" } }, { { (1<<RVEXT_RV32FC), 0 } } } }
  },
...
/* c.fldsp ${fl-rd},${uimm9-43-121-62-000-abs}(${sp-reg}) */
  {
    ...
    { 0, { { { (1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\xc0" } }, { { (1<<RVEXT_RV32DC)|(1<<RVEXT_RV64DC), 0 } } } }
  },
...
/* fence.i */
  {
    ...
    { 0, { { { (1<<MACH_RV32I)|(1<<MACH_RV32IC)|(1<<MACH_RV32IM)|(1<<MACH_RV32IMC)|(1<<MACH_RV32G)|(1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64I)|(1<<MACH_RV64IC)|(1<<MACH_RV64IM)|(1<<MACH_RV64IMC)|(1<<MACH_RV64G)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\xc0" } }, { { (1<<RVEXT_RV32IFENCEI)|(1<<RVEXT_RV64IFENCEI), 0 } } } }
  },
/* ecall */
  {
...
/* csrrw ${rd},${csr},${rs1} */
  {
    ...
    { 0, { { { (1<<MACH_RV32I)|(1<<MACH_RV32IC)|(1<<MACH_RV32IM)|(1<<MACH_RV32IMC)|(1<<MACH_RV32G)|(1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64I)|(1<<MACH_RV64IC)|(1<<MACH_RV64IM)|(1<<MACH_RV64IMC)|(1<<MACH_RV64G)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\xc0" } }, { { (1<<RVEXT_RV32ICSR)|(1<<RVEXT_RV64ICSR), 0 } } } }
  },
/* csrrs ${rd},${csr},${rs1} */
  {
...
/* sbseti ${rd},${rs1},${uimm6-256} */
  {
    ...
    { 0, { { { (1<<MACH_RV32G)|(1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64G)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\x40" } }, { { (1<<RVEXT_RV32ZBS)|(1<<RVEXT_RV64ZBS), 0 } } } }
  },
...
/* sloi ${rd},${rs1},${uimm6-256} */
  {
    ...
    { 0, { { { (1<<MACH_RV32G)|(1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64G)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\x40" } }, { { (1<<RVEXT_RV32ZBB)|(1<<RVEXT_RV64ZBB), 0 } } } }
  },
...
/* shfli ${rd},${rs1},${uimm6-256} */
  {
    ...
    { 0, { { { (1<<MACH_RV32G)|(1<<MACH_RV32GC)|(1<<MACH_RV32GQC)|(1<<MACH_RV64G)|(1<<MACH_RV64GC)|(1<<MACH_RV64GQC), 0 } }, { { 1, "\x40" } }, { { (1<<RVEXT_RV32ZBP)|(1<<RVEXT_RV64ZBP), 0 } } } }
  },
