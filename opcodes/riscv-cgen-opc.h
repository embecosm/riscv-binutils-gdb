...
typedef enum cgen_insn_type {
 ...
 , RISCV_INSN_PACK, RISCV_INSN_PACKU, RISCV_INSN_PACKH, RISCV_INSN_PACKW
 , RISCV_INSN_PACKUW, RISCV_INSN_MIN, RISCV_INSN_MAX, RISCV_INSN_MINU
 , RISCV_INSN_MAXU, RISCV_INSN_SEXT_B, RISCV_INSN_SEXT_H, RISCV_INSN_SBSET
 , RISCV_INSN_SBCLR, RISCV_INSN_SBINV, RISCV_INSN_SBEXT, RISCV_INSN_SBSETI_SHIFT6
 , RISCV_INSN_SBCLRI_SHIFT6, RISCV_INSN_SBINVI_SHIFT6, RISCV_INSN_SBEXTI_SHIFT6, RISCV_INSN_SBSETW
 , RISCV_INSN_SBCLRW, RISCV_INSN_SBINVW, RISCV_INSN_SBEXTW, RISCV_INSN_SBSETIW_SHIFT5
 , RISCV_INSN_SBCLRIW_SHIFT5, RISCV_INSN_SBINVIW_SHIFT5, RISCV_INSN_SLO, RISCV_INSN_SRO
 , RISCV_INSN_SLOI_SHIFT6, RISCV_INSN_SROI_SHIFT6, RISCV_INSN_SLOW, RISCV_INSN_SROW
 , RISCV_INSN_SLOIW_SHIFT5, RISCV_INSN_SROIW_SHIFT5, RISCV_INSN_ROL, RISCV_INSN_ROR
 , RISCV_INSN_RORI_SHIFT6, RISCV_INSN_ROLW, RISCV_INSN_RORW, RISCV_INSN_RORIW_SHIFT5
 , RISCV_INSN_GREV, RISCV_INSN_GREVI_SHIFT6, RISCV_INSN_GREVW, RISCV_INSN_GREVIW_SHIFT5
 , RISCV_INSN_SHFL, RISCV_INSN_UNSHFL, RISCV_INSN_SHFLI_SHIFT6, RISCV_INSN_UNSHFLI_SHIFT6
 , RISCV_INSN_SHFLW, RISCV_INSN_UNSHFLW, RISCV_INSN_GORC, RISCV_INSN_GORCI_SHIFT6
 , RISCV_INSN_GORCW, RISCV_INSN_GORCIW_SHIFT5, RISCV_INSN_BFP, RISCV_INSN_BFPW
 , RISCV_INSN_BEXT, RISCV_INSN_BDEP, RISCV_INSN_BEXTW, RISCV_INSN_BDEPW
 , RISCV_INSN_CLMUL, RISCV_INSN_CLMULH, RISCV_INSN_CLMULR, RISCV_INSN_CLMULW
 , RISCV_INSN_CLMULHW, RISCV_INSN_CLMULRW, RISCV_INSN_CRC32_B, RISCV_INSN_CRC32_H
 , RISCV_INSN_CRC32_W, RISCV_INSN_CRC32C_B, RISCV_INSN_CRC32C_H, RISCV_INSN_CRC32C_W
 , RISCV_INSN_CRC32_D, RISCV_INSN_CRC32C_D, RISCV_INSN_BMATOR, RISCV_INSN_BMATXOR
 , RISCV_INSN_BMATFLIP, RISCV_INSN_CMIX, RISCV_INSN_CMOV, RISCV_INSN_FSL
 , RISCV_INSN_FSR, RISCV_INSN_FSRI, RISCV_INSN_FSLW, RISCV_INSN_FSRW
 , RISCV_INSN_FSRIW, RISCV_INSN_ADDWU, RISCV_INSN_SUBWU, RISCV_INSN_ADDIWU
 , RISCV_INSN_ADDU_W, RISCV_INSN_SUBU_W, RISCV_INSN_SLLIU_W_SHIFT7, RISCV_INSN_FLW
 ...
 , RISCV_INSN_FMV_W_X, RISCV_INSN_FCVT_S_L, RISCV_INSN_FCVT_S_LU, RISCV_INSN_FCVT_L_S
 , RISCV_INSN_FCVT_LU_S, RISCV_INSN_FLD, RISCV_INSN_FSD, RISCV_INSN_FMADD_D
 ...
 , RISCV_INSN_FCVT_Q_LU, RISCV_INSN_INSN_R_FFF, RISCV_INSN_INSN_R_FGG, RISCV_INSN_INSN_R_GFG
 , RISCV_INSN_INSN_R_GGF, RISCV_INSN_INSN_R_FFG, RISCV_INSN_INSN_R_FGF, RISCV_INSN_INSN_R_GFF
 , RISCV_INSN_INSN_R4, RISCV_INSN_INSN_R, RISCV_INSN_INSN_I_1, RISCV_INSN_INSN_I_2
 , RISCV_INSN_INSN_S, RISCV_INSN_INSN_SB_1, RISCV_INSN_INSN_SB_2, RISCV_INSN_INSN_U
 , RISCV_INSN_INSN_UJ, RISCV_INSN_INSN_CI, RISCV_INSN_INSN_CR, RISCV_INSN_INSN_CIW
 , RISCV_INSN_INSN_CA, RISCV_INSN_INSN_CB, RISCV_INSN_INSN_CJ
} CGEN_INSN_TYPE;
