...
typedef enum cgen_insn_type {
 ...
 , RISCV_INSN_FMV_X_S, RISCV_INSN_FCLASS_S, RISCV_INSN_FCVT_S_W, RISCV_INSN_FCVT_S_WU
 , RISCV_INSN_FMV_S_X, RISCV_INSN_FCVT_L_S, RISCV_INSN_FCVT_LU_S, RISCV_INSN_FCVT_S_L
...
#define MAX_INSNS ((int) RISCV_INSN_FMV_D_X + 1)
