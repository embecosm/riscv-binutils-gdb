...
typedef enum cgen_insn_type {
 ...
 , RISCV_INSN_C_JAL, RISCV_INSN_C_FLWSP, RISCV_INSN_C_FSWSP, RISCV_INSN_C_FSW
 , RISCV_INSN_C_FLW, RISCV_INSN_C_ADDW, RISCV_INSN_C_SUBW, RISCV_INSN_C_ADDIW
...
#define MAX_INSNS ((int) RISCV_INSN_FCVT_S_LU + 1)
