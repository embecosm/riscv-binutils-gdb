...
typedef enum cgen_insn_type {
 ...
 , RISCV_INSN_SBCLR, RISCV_INSN_SBINV, RISCV_INSN_SBEXT, RISCV_INSN_CLMUL
 , RISCV_INSN_CLMULR, RISCV_INSN_CLMULH, RISCV_INSN_MIN, RISCV_INSN_MAX
 , RISCV_INSN_MINU, RISCV_INSN_MAXU, RISCV_INSN_SHFL, RISCV_INSN_UNSHFL
 , RISCV_INSN_BDEP, RISCV_INSN_BEXT, RISCV_INSN_PACK, RISCV_INSN_GREVI
 , RISCV_INSN_SLOI, RISCV_INSN_SROI, RISCV_INSN_RORI, RISCV_INSN_SBSETI
 , RISCV_INSN_SBCLRI, RISCV_INSN_SBINVI, RISCV_INSN_SBEXTI, RISCV_INSN_SHFLI_SHIFT6
 , RISCV_INSN_UNSHFLI_SHIFT6, RISCV_INSN_CMIX, RISCV_INSN_CMOV, RISCV_INSN_FSL
 , RISCV_INSN_FSR, RISCV_INSN_FSRI, RISCV_INSN_CLZ, RISCV_INSN_CTZ
 , RISCV_INSN_PCNT, RISCV_INSN_CRC32_B, RISCV_INSN_CRC32_H, RISCV_INSN_CRC32_W
 , RISCV_INSN_CRC32C_B, RISCV_INSN_CRC32C_H, RISCV_INSN_CRC32C_W, RISCV_INSN_BMATFLIP
 , RISCV_INSN_CRC32_D, RISCV_INSN_CRC32C_D, RISCV_INSN_ADDIWU, RISCV_INSN_SLLIU_W
 , RISCV_INSN_BMATOR, RISCV_INSN_BMATXOR, RISCV_INSN_ADDWU, RISCV_INSN_SUBWU
 ...
 , RISCV_INSN_SBCLRW, RISCV_INSN_SBINVW, RISCV_INSN_SBEXTW, RISCV_INSN_GREVIW
 , RISCV_INSN_SLOIW, RISCV_INSN_SROIW, RISCV_INSN_ROLIW, RISCV_INSN_RORIW
 , RISCV_INSN_SBSETIW, RISCV_INSN_SBCLRIW, RISCV_INSN_SBINVIW, RISCV_INSN_CLMULW
 , RISCV_INSN_CLMULRW, RISCV_INSN_CLMULHW, RISCV_INSN_SHFLW, RISCV_INSN_UNSHFLW
 , RISCV_INSN_BDEPW, RISCV_INSN_BEXTW, RISCV_INSN_PACKW, RISCV_INSN_FSLW
 , RISCV_INSN_FSRW, RISCV_INSN_FSRIW, RISCV_INSN_CLZW, RISCV_INSN_CTZW
 , RISCV_INSN_PCNTW, RISCV_INSN_FLW, RISCV_INSN_FSW, RISCV_INSN_FMADD_S
