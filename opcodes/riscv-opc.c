...
static const CGEN_IFMT ifmt_p_c_flwsp ATTRIBUTE_UNUSED = {
  16, 16, 0xe003, { { F (F_C_FUNCT3) }, { F (F_UIMM8_32_121_63_00) }, { F (F_RD) }, { F (F_C_OPCODE) }, { 0 } }
};

static const CGEN_IFMT ifmt_p_c_fswsp ATTRIBUTE_UNUSED = {
  16, 16, 0xe003, { { F (F_C_FUNCT3) }, { F (F_UIMM8_82_124_00) }, { F (F_UIMM5_65) }, { F (F_C_OPCODE) }, { 0 } }
};

static const CGEN_IFMT ifmt_p_c_fsw ATTRIBUTE_UNUSED = {
...
static const CGEN_IFMT ifmt_p_c_fldsp ATTRIBUTE_UNUSED = {
  16, 16, 0xe003, { { F (F_C_FUNCT3) }, { F (F_UIMM9_43_121_62_000) }, { F (F_RD) }, { F (F_C_OPCODE) }, { 0 } }
};

static const CGEN_IFMT ifmt_p_c_fsdsp ATTRIBUTE_UNUSED = {
  16, 16, 0xe003, { { F (F_C_FUNCT3) }, { F (F_UIMM9_93_123_000) }, { F (F_UIMM5_65) }, { F (F_C_OPCODE) }, { 0 } }
};

static const CGEN_IFMT ifmt_p_c_fsd ATTRIBUTE_UNUSED = {
...
/* j ${cjmp12} */
  {
    -1, "p-c-j", "j", 16,
    { 0|A(RELAXABLE)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x6\x0\x0" } } } }
  },
/* jal ${cjmp12} */
  {
    -1, "p-c-jal", "jal", 16,
    { 0|A(RELAXABLE)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x4\x0\x0" } } } }
  },
...
/* lw ${c-reg42},(${c-reg97}) */
  {
    -1, "p-c-lw-3", "lw", 16,
    { 0|A(NO_DIS)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x6\x0\x0" } } } }
  },
...
/* beqz ${rs1},${branch13} */
  {
    -1, "p-beqz", "beqz", 32,
    { 0|A(RELAXABLE)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\xe0\x0\x0" } } } }
  },
/* bnez ${rs1},${branch13} */
  {
    -1, "p-bnez", "bnez", 32,
...
/* bgt ${rs2},${rs1},${branch13} */
  {
    -1, "p-bgt", "bgt", 32,
    { 0|A(NO_DIS)|A(RELAXABLE)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\xe0\x0\x0" } } } }
  },
...
/* rdinstreth ${rd} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x80\x0\x0" } } } }
  },
/* rdcycleh ${rd} */
  {
...
/* addw ${rd},${rs1},${imm-lo12-abs} */
  {
    -1, "p-addw", "addw", 32,
    { 0|A(NO_DIS)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x40\x0\x0" } } } }
  },
...
/* sext.w ${rd},${rs1} */
  {
    -1, "p-sextw", "sext.w", 32,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x40\x0\x0" } } } }
  },
/* flw ${fl-rd},${imm-lo12},${rs1} */
  {
    -1, "p-flw", "flw", 32,
    { 0|A(NO_DIS)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x60\x0" } } } }
  },
/* fsw ${fl-rs2},${store12},${rs1} */
  {
    -1, "p-fsw", "fsw", 32,
...
/* frsr ${rd} */
  {
    -1, "p-frsr", "frsr", 32,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x60\x0" } } } }
  },
/* fssr ${rd},${rs1} */
  {
    -1, "p-fssr-1", "fssr", 32,
...
/* fcvt.l.s ${rd},${fl-rs1} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x20\x0" } } } }
  },
/* fcvt.lu.s ${rd},${fl-rs1} */
  {
...
/* flw ${fl-rd},${uimm8-32-121-63-00-abs}(${sp-reg}) */
  {
    -1, "p-c-flwsp", "flw", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x1\x0" } } } }
  },
/* fsw ${fc-rs3},${uimm8-82-124-00-abs}(${sp-reg}) */
  {
    -1, "p-c-fswsp", "fsw", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x1\x0" } } } }
  },
/* fsw ${fc-rs2},${uimm7-51-123-61-00-abs}(${c-reg97}) */
  {
    -1, "p-c-fsw", "fsw", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x1\x0" } } } }
  },
...
/* fld ${fl-rd},${uimm9-43-121-62-000-abs}(${sp-reg}) */
  {
    -1, "p-c-fldsp", "fld", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x0\xc0" } } } }
  },
/* fsd ${fc-rs3},${uimm9-93-123-000-abs}(${sp-reg}) */
  {
    -1, "p-c-fsdsp", "fsd", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x0\xc0" } } } }
  },
/* fsd ${fc-rs2},${uimm8-62-123-000-abs}(${c-reg97}) */
  {
    -1, "p-c-fsd", "fsd", 16,
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x0\xc0" } } } }
  },
...
/* fld ${fl-rd},${imm-lo12},${rs1} */
  {
    -1, "p-fld", "fld", 32,
    { 0|A(NO_DIS)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x18\x0" } } } }
  },
/* fsd ${fl-rs2},${store12},${rs1} */
  {
    -1, "p-fsd", "fsd", 32,
...
/* fmadd.d ${fl-rd},${fl-rs1},${fl-rs2},${fl-rs3} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x18\x0" } } } }
  },
...
/* fcvt.l.d ${rd},${fl-rs1} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x8\x0" } } } }
  },
/* fcvt.lu.d ${rd},${fl-rs1} */
  {
...
/* flq ${fl-rd},${imm-lo12},${rs1} */
  {
    -1, "p-flq", "flq", 32,
    { 0|A(NO_DIS)|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x6\x0" } } } }
  },
/* fsq ${fl-rs2},${store12},${rs1} */
  {
    -1, "p-fsq", "fsq", 32,
...
/* fmadd.q ${fl-rd},${fl-rs1},${fl-rs2},${fl-rs3} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x6\x0" } } } }
  },
...
/* fcvt.l.q ${rd},${fl-rs1} */
  {
    ...
    { 0|A(ALIAS), { { { (1<<MACH_BASE), 0 } }, { { 3, "\x0\x2\x0" } } } }
  },
/* fcvt.lu.q ${rd},${fl-rs1} */
  {
...
/* flw ${fl-rd},${uimm8-32-121-63-00-abs}(${sp-reg}) */
  {
    { 0, 0, 0, 0 },
    { { MNEM, ' ', OP (FL_RD), ',', OP (UIMM8_32_121_63_00_ABS), '(', OP (SP_REG), ')', 0 } },
    & ifmt_p_c_flwsp, { 0x6002 }
  },
/* fsw ${fc-rs3},${uimm8-82-124-00-abs}(${sp-reg}) */
  {
    { 0, 0, 0, 0 },
    { { MNEM, ' ', OP (FC_RS3), ',', OP (UIMM8_82_124_00_ABS), '(', OP (SP_REG), ')', 0 } },
    & ifmt_p_c_fswsp, { 0xe002 }
  },
/* fsw ${fc-rs2},${uimm7-51-123-61-00-abs}(${c-reg97}) */
  {
    { 0, 0, 0, 0 },
...
/* fld ${fl-rd},${uimm9-43-121-62-000-abs}(${sp-reg}) */
  {
    { 0, 0, 0, 0 },
    { { MNEM, ' ', OP (FL_RD), ',', OP (UIMM9_43_121_62_000_ABS), '(', OP (SP_REG), ')', 0 } },
    & ifmt_p_c_fldsp, { 0x2002 }
  },
/* fsd ${fc-rs3},${uimm9-93-123-000-abs}(${sp-reg}) */
  {
    { 0, 0, 0, 0 },
    { { MNEM, ' ', OP (FC_RS3), ',', OP (UIMM9_93_123_000_ABS), '(', OP (SP_REG), ')', 0 } },
    & ifmt_p_c_fsdsp, { 0xa002 }
  },
/* fsd ${fc-rs2},${uimm8-62-123-000-abs}(${c-reg97}) */
  {
    { 0, 0, 0, 0 },
