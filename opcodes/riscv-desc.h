...
typedef enum cgen_hw_type {
 ...
 , HW_H_DPR, HW_H_C_FPR, HW_H_OPCODE7, HW_H_COPCODE2
 , HW_MAX
} CGEN_HW_TYPE;
...
typedef enum cgen_operand_type {
 ...
 , RISCV_OPERAND_FL_RS2, RISCV_OPERAND_FL_RS3, RISCV_OPERAND_DP_RD, RISCV_OPERAND_DP_RS1
 , RISCV_OPERAND_DP_RS2, RISCV_OPERAND_DP_RS3, RISCV_OPERAND_FC_RS2, RISCV_OPERAND_FC_RS3
 , RISCV_OPERAND_FL_TIED_REGS1915, RISCV_OPERAND_FL_DUMMY, RISCV_OPERAND_CSR, RISCV_OPERAND_PRED
 , RISCV_OPERAND_SUCC, RISCV_OPERAND_FL_RM, RISCV_OPERAND_DP_RM, RISCV_OPERAND_TPREL_ADD
 , RISCV_OPERAND_IMM_ZERO, RISCV_OPERAND_UIMM5, RISCV_OPERAND_UIMM5_DEC, RISCV_OPERAND_UIMM5_ABS
 , RISCV_OPERAND_UIMM8_128, RISCV_OPERAND_IMM_LO12, RISCV_OPERAND_IMM_LO12_HEX, RISCV_OPERAND_IMM_LO12_ABS
...
extern CGEN_KEYWORD riscv_cgen_opval_h_dpr;
